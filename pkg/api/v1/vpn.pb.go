...
func (EnginePhase) Descriptor() protoreflect.EnumDescriptor {
	return file_vpn_proto_enumTypes[3].Descriptor()
}

func (EnginePhase) Type() protoreflect.EnumType {
	return &file_vpn_proto_enumTypes[3]
}
...
func (LogSliceType) Descriptor() protoreflect.EnumDescriptor {
	return file_vpn_proto_enumTypes[4].Descriptor()
}

func (LogSliceType) Type() protoreflect.EnumType {
	return &file_vpn_proto_enumTypes[4]
}
...
var file_vpn_proto_rawDesc = []byte{
	0x0a, 0x09, 0x76, 0x70, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x76, 0x31, 0x1a,
	...
	0x55, 0x4c, 0x54, 0x10, 0x06, 0x32, 0xa6, 0x04, 0x0a, 0x0a, 0x56, 0x70, 0x6e, 0x53, 0x65, 0x72,
	...
	0x6a, 0x70, 0x75, 0x72, 0x2f, 0x76, 0x70, 0x6e, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69,
...
var file_vpn_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
...
var file_vpn_proto_depIdxs = []int32{
	...
	5,  // 27: v1.VpnService.StartLocalEngine:input_type -> v1.StartLocalEngineRequest
	8,  // 28: v1.VpnService.StartFromPreviousEngine:input_type -> v1.StartFromPreviousEngineRequest
	7,  // 29: v1.VpnService.StartEngine:input_type -> v1.StartEngineRequest
	9,  // 30: v1.VpnService.ListEngines:input_type -> v1.ListEnginesRequest
	14, // 31: v1.VpnService.Subscribe:input_type -> v1.SubscribeRequest
	16, // 32: v1.VpnService.GetEngine:input_type -> v1.GetEngineRequest
	18, // 33: v1.VpnService.Listen:input_type -> v1.ListenRequest
	27, // 34: v1.VpnService.StopEngine:input_type -> v1.StopEngineRequest
	6,  // 35: v1.VpnService.StartLocalEngine:output_type -> v1.StartEngineResponse
	6,  // 36: v1.VpnService.StartFromPreviousEngine:output_type -> v1.StartEngineResponse
	6,  // 37: v1.VpnService.StartEngine:output_type -> v1.StartEngineResponse
	13, // 38: v1.VpnService.ListEngines:output_type -> v1.ListEnginesResponse
	15, // 39: v1.VpnService.Subscribe:output_type -> v1.SubscribeResponse
	17, // 40: v1.VpnService.GetEngine:output_type -> v1.GetEngineResponse
	19, // 41: v1.VpnService.Listen:output_type -> v1.ListenResponse
	28, // 42: v1.VpnService.StopEngine:output_type -> v1.StopEngineResponse
...
func file_vpn_proto_init() {
	...
	file_vpn_proto_msgTypes[0].OneofWrappers = []interface{}{
